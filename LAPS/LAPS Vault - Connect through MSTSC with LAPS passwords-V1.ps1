...
# Try to load ActiveDirectory module and valid if it's done. If it isnt, scripts end.
...
#>
    ...
    process {
        ...
        # Clean variable, add var for date/time and test connection to host
        $HostNetTest = $null
        ...
        # Check if host is with 3389 port opened
